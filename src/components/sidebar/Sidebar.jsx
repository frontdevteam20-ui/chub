    ...
    <>
      ...
      >
        <div className="flex flex-col h-full p-6 gap-3 text-left overflow-y-auto" style={{
          ...
          {/* Menu Section */}
          <div className="mb-2">
            <h3 className="text-xs font-bold text-black-500 uppercase tracking-wider mb-3 px-4">Menu</h3>
          ...
          <div className="mb-2">
            <h3 className="text-xs font-bold text-black-500 uppercase tracking-wider mb-3 px-4">Integrations</h3>
