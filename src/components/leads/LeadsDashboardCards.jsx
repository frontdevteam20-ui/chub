...
import { FaUsers, FaUserPlus, FaCalendarDay, FaCalendarWeek } from 'react-icons/fa';

const LeadsDashboardCard = ({ title, value, icon: Icon, color, gradientFrom, gradientTo, loading }) => (
  <div 
...
const LeadsDashboardCards = ({ loading, totalLeads, newLeadsThisWeek, leadsToday, leadsThisMonth }) => {
  const cardConfigs = [
    {
      title: 'Total Leads',
      value: totalLeads,
...
export default LeadsDashboardCards;