...
const FormDashboardCard = ({ title, value, icon: Icon, color, gradientFrom, gradientTo, loading }) => (
  <div 
...
const FormsDashboardCards = ({ loading, totalForms, formsToday, formsThisMonth }) => {
  const cardConfigs = [
    {
      title: 'Total Forms',
      value: totalForms,
...
export default FormsDashboardCards;